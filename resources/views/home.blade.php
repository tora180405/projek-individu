...
@section('content')
        ...
        <section class="jumbotron text-center">
            <img src="https://static.dw.com/image/62450424_403.jpeg" alt="bruh" width="300" class=" rounded-circle img-thumbnail">
            <h1 class="display-4">Tora Digda Kristiawan</h1>
            <p class="lead">12 RPL 2 | Absen 35</p>
        </section>
